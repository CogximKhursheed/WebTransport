<%@ Page Language="C#" Title="Hire Invoice List" AutoEventWireup="true" MasterPageFile="~/Site1.Master"
    CodeBehind="ManageHireInvoice.aspx.cs" Inherits="WebTransport.ManageHireInvoice" %>
    ...
    <div class="center-block" style="width: 90%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Hire Invoice List </h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="HireInvoice.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
            <div class="ibox-content">
                <div class="">
                            ...
                            <div class="control-holder full-width">
                                <asp:TextBox ID="txtInvoiceno" runat="server"  CssClass="form-control backlight" MaxLength="50" ></asp:TextBox>
                            </div>
                        </div>
                                <!--SECOND-FOLD-->
                                <div class="col-sm-12 no-pad">
                ...
                <div class="panel-in-default" >
                    ...
                    <div class="report" style="overflow-x:Auto; width:100%;">
                         <table>
                            ...
                            <td> 
                            <div>
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None" AllowPaging="true" PageSize="50" onrowcommand="grdMain_RowCommand" onrowdatabound="grdMain_RowDataBound" onpageindexchanging="grdMain_PageIndexChanging1">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Invoice No." HeaderStyle-CssClass="gridHeaderAlignCenter"  HeaderStyle-Width="100px">
                                        <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemStyle HorizontalAlign="Center" Width="100" />
                                        <ItemTemplate>
                                            <%#Eval("Hire_InvNo")%>
                                            <asp:Label ID="lblGridNo" runat="server" Text='<%#Eval("Hire_InvNo") %>' Visible="false"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                <asp:TemplateField HeaderText="Invoice Date" HeaderStyle-CssClass="gridHeaderAlignCenter" HeaderStyle-Width="100">
                                        <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemStyle HorizontalAlign="Center" Width="100" />
                                        <ItemTemplate>
                                            <%#Convert.ToDateTime(Eval("Hire_Date")).ToString("dd-MM-yyyy")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                <asp:TemplateField HeaderText="Location" HeaderStyle-CssClass="gridHeaderAlignCenter" HeaderStyle-Width="100">
                                        <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                        <ItemStyle HorizontalAlign="Center" Width="100" />
                                        <ItemTemplate>
                                            <%#Eval("Location")%>
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="gridHeaderAlignRight" HeaderStyle-Width="150" HeaderText="Net Amount">
                                ...
                                <asp:TemplateField HeaderText="Action" HeaderStyle-Width="10px" HeaderStyle-CssClass="gridHeaderAlignCenter">
                                        <HeaderStyle HorizontalAlign="Center" Width="10px" />
                                        <ItemStyle HorizontalAlign="Center" Width="10px" />
                                        <ItemTemplate>
                                        <asp:LinkButton ID="lnkbtnEdit" CssClass="edit" runat="server" CommandArgument='<%#Eval("Hire_Idno") %>' CommandName="cmdedit" TabIndex="100" ToolTip="Click to edit"><i class="fa fa-edit icon"></i></asp:LinkButton>
                                        <asp:LinkButton ID="lnkbtnDelete" CssClass="delete" runat="server" CommandArgument='<%#Eval("Hire_Idno") %>' OnClientClick="return confirm('Do you want to delete this record ?');" CommandName="cmddelete" TabIndex="101" ToolTip="Click to delete"><i class="fa fa-trash-o"></i></asp:LinkButton>
                        ...
                        <table class="" id="tblFooterscnd" runat="server" >
		                    <tr><th rowspan="1" colspan="1" style="width:350px;"> <asp:Label ID="lblcontant" runat="server"></asp:Label></th><th rowspan="1" colspan="1" style="width: 149px;"></th><th rowspan="1" colspan="1" style="width: 300px;text-align:right;">Total</th><th rowspan="1" colspan="1" style="width: 315px; text-align: right;"><asp:Label ID="lblNetTotalAmount" runat="server"></asp:Label>
