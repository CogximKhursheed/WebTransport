...
{
    public partial class PJLBillInvoice : System.Web.UI.Page
    {
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                Dtotweight += Convert.ToDouble(DataBinder.Eval(e.Item.DataItem, "Weight"));
                Dtotqty += Convert.ToDouble(DataBinder.Eval(e.Item.DataItem, "Rate"));
            ...
            else if (e.Item.ItemType == ListItemType.Footer)
            {
                ...
                lbltweight.Text = Dtotweight.ToString("N2");
                lbltrate.Text = Dtotqty.ToString("N2");
                lbltamount.Text = dtotAmnt.ToString("N2");
