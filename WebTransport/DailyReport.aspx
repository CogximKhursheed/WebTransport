<%@ Page Title="Daily Report" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DailyReport.aspx.cs" EnableEventValidation="false" Inherits="WebTransport.DailyReport" %>
                            ...
                            <div class="filter" style="width: 400px; display: none;">
                                ...
                                <div class="col-sm-12">
                                    <div class="col-sm-6 pull-left" style="visibility: hidden;">
                                        ...
                                        <div class="control-holder full-width">
                                            <asp:DropDownList ID="ddlRepType" runat="server" Visible="false" CssClass="form-control">
                                    ...
                                    <div class="col-sm-6 pull-left" style="visibility: hidden;">
                                        ...
                                        <div class="control-holder full-width">
                                            <asp:TextBox ID="txtInvoiceNo" runat="server" Visible="false" placeHolder="Invoice Number" CssClass="form-control" MaxLength="12"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 pull-left" style="visibility: hidden;">
                                        <div class="control-holder full-width">
                                        ...
                                        <div class="control-holder full-width">
                                            <asp:DropDownList ID="ddlInvType" runat="server" Visible="false" CssClass="form-control" TabIndex="6">
                            ...
                            <div class="table-responsive nowrap dataTable slim-scrollbar fixed-header-table-scroll" style="max-height: calc(100vh - 230px);">
                                <div id="divPrint">
                                    <table width="100%">
                                        <tr>
                                            <td>
                                                <%--<asp:Panel ID="pnlreport" runat="server" style="width: 99%; height: calc(100vh - 350px); padding-bottom: 58px;">--%>
                                                <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" BorderStyle="None" CssClass="u-table u-table-green u-table-stripped fixed-header-table bold-last-row row-selection no-wrap-cell" GridLines="None" BorderWidth="0" ShowFooter="true" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Ordr No." HeaderStyle-Width="120" HeaderStyle-HorizontalAlign="center">
                                                            <ItemStyle HorizontalAlign="center" Width="120" />
                                                            <ItemTemplate>
                                                                <%#Eval("Ordr_No")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Inv. No." HeaderStyle-Width="120" HeaderStyle-HorizontalAlign="Center">
                                                            <ItemStyle HorizontalAlign="Center" Width="120" />
                                                            <ItemTemplate>
                                                                <%#Eval("Inv_No")%>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="DI No." HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="Right">
                                                            <ItemStyle HorizontalAlign="Right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#Eval("DI_NO")%>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="MT" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="Right">
                                                            <ItemStyle HorizontalAlign="Right" Width="80" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("Weight"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("Weight")))))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Rate" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("Rate"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("Rate")))))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Toll" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("TollTax_Amnt"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("TollTax_Amnt")))))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="U/L Wght" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("UL"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("UL")))))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Unloading" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("Wages_Amnt"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("Wages_Amnt")))))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Short MT" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("SHORT_MT"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("SHORT_MT")))))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Amt" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("Amount"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("Amount")))))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Comm." HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("COMM"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("COMM")))))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Adv" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("Adv"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("Adv")))))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Diesel" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("DIESEL"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("DIESEL")))))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="PAN" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="Center">
                                                            <ItemStyle HorizontalAlign="Center" Width="80" />
                                                            <ItemTemplate>
                                                                <%#Eval("PAN")%>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Remark" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="Center">
                                                            <ItemStyle HorizontalAlign="Center" Width="80" />
                                                            <ItemTemplate>
                                                                <%#(string.IsNullOrEmpty(Convert.ToString(Eval("REMARK"))) ? "" : Convert.ToString(Eval("REMARK")))%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterScriptPlaceHolder" runat="server">
    <script>
        ...
        $(document).ready(function () { $(".classPager").parent().parent().parent("div").css("padding-bottom", "45px") });
    </script>
    <script language="javascript" type="text/javascript">
