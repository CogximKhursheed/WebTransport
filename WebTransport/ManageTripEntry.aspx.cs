...
{
    public partial class ManageTripEntry : Pagebase
    {
        ...
        private void BindGrid()
        {
            ...
            if (lstGridData != null && lstGridData.Count > 0)
            {
                ...
                for (int i = 0; i < lstGridData.Count; i++)
                {
                    ...
                    dr["TripNo"] = Convert.ToString(DataBinder.Eval(lstGridData[i], "Trip_No"));
                    dr["Date"] = Convert.ToDateTime(DataBinder.Eval(lstGridData[i], "Trip_Date")).ToString("dd-MM-yyyy");
        ...
        protected void grdMain_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("TripEntry.aspx?TripI=" + e.CommandArgument, true);
            }
