<%@ Page Title="TYRE MOVEMENT REPORT" Language="C#" MasterPageFile="~/Site1.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="TyreMovementReport.aspx.cs" Inherits="WebTransport.TyreMovementReport" %>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6 pull-left">
                                            ...
                                            <div class="control-holder full-width">
                                                <asp:TextBox ID="txtSerialNo" PlaceHolder="Serial Number" runat="server" AutoPostBack="false" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <td>
                                                <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" BorderStyle="None" CssClass="u-table u-table-green u-table-stripped fixed-header-table bold-last-row row-selection no-wrap-cell" GridLines="None" BorderWidth="0" ShowFooter="true" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCreated="grdMain_RowCreated">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="In Type" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemStyle HorizontalAlign="Left" Width="80" />
                                                            <ItemTemplate>
                                                                <%#Eval("StckIn")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Doc No." HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="Right">
                                                            <ItemStyle HorizontalAlign="Right" Width="70" />
                                                            <ItemTemplate>
                                                                <%#Eval("DocNo")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Doc Date" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="Center">
                                                            <ItemStyle HorizontalAlign="Center" Width="80" />
                                                            <ItemTemplate>
                                                                <%#Convert.ToDateTime(Eval("DocDate")).ToString("dd-MM-yyyy")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Out Type" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemStyle HorizontalAlign="Left" Width="80" />
                                                            <ItemTemplate>
                                                                <%#Eval("StckOut")%>
                                                            </ItemTemplate>
                                                ...
                                                <b>
                                                    <div class="secondFooterClass" id="divpaging" runat="server" visible="false">
                                                        <div class="col-sm-2" style="text-align: left">
                                                            <asp:Label ID="lblcontant" runat="server"></asp:Label></div>
                                                    </div>
                                                </b>
                                            </td>
                                        </tr>
