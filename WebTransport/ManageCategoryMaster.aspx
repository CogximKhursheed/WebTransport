<%@ Page Title="Category Master List" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ManageCategoryMaster.aspx.cs"
    Inherits="WebTransport.ManageCategoryMaster" %>
    ...
    <div class="center-block" style="width: 50%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Category Master List </h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="CategoryMaster.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
            <div class="ibox-content">
                <div class="">
                            ...
                            <div class="control-holder full-width">
                                <asp:TextBox ID="txtConType" runat="server" placeholder="Enter Category Name" CssClass="form-control backlight" MaxLength="50" onDrop="blur();return false;" onpaste="return false" oncut="return false" oncopy="return false"></asp:TextBox>                                 
                            </div>
                        </div>
                                <!--SECOND-FOLD-->
                                <div class="col-sm-6 no-pad">
                    ...
                    <div class="report" style="overflow-x:Auto; width:100%;">
                        ...
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" OnRowDataBound="grdMain_RowDataBound">
                            <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="Container Size" HeaderStyle-CssClass="gridHeaderAlignLeft" HeaderStyle-Width="225">
                                  ...
                                  <asp:TemplateField HeaderText="Status" HeaderStyle-CssClass="gridHeaderAlignCenter" HeaderStyle-Width="30">
                                                    ...
                                                    <ItemTemplate>
                                                        <asp:ImageButton ID="imgBtnStatus" runat="server" Width="15px" Height="15px" CommandArgument='<%#Eval("Cat_Idno")+"_"+Eval("Status") %>'
                                  ...
                                  <asp:TemplateField HeaderText="Action" HeaderStyle-Width="30" HeaderStyle-CssClass="gridHeaderAlignCenter">
                                                    ...
                                                    <ItemTemplate>
                                                     <asp:LinkButton ID="lnkbtnEdit" CssClass="edit" runat="server" CommandArgument='<%#Eval("Cat_Idno") %>' CommandName="cmdedit" TabIndex="4" ToolTip="Click to edit"><i class="fa fa-edit icon"></i></asp:LinkButton>
                                                     <asp:LinkButton ID="lnkbtnDelete" CssClass="delete" runat="server" CommandArgument='<%#Eval("Cat_Idno") %>' OnClientClick="return confirm('Do you want to delete this record ?');" CommandName="cmddelete" TabIndex="5" ToolTip="Click to delete"><i class="fa fa-trash-o"></i></asp:LinkButton>                                                       
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                            </Columns>
