<%@ Page Title="CITY MASTER LIST" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ManageCityMaster.aspx.cs"
    Inherits="WebTransport.ManageCityMaster" %>
    ...
    <div class="center-block" style="width: 50%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>City Master List </h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="CityMaster.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
            <div class="ibox-content">
                <div class="">
                            ...
                            <div class="control-holder full-width">
                                <asp:TextBox ID="txtCityName" runat="server" placeholder="Enter City Name" CssClass="form-control backlight" MaxLength="50"></asp:TextBox>                                  
                            </div>
                        </div>
                                <div class="col-sm-6 no-pad">
                            <div class="control-label"> 
                                <span>As Location</span>
                            </div>
                            <div class="control-holder full-width">
                                 <asp:DropDownList ID="ddlLoc" runat="server" CssClass="form-control backlight">
                                   <asp:ListItem Text="All" Value="0"></asp:ListItem>
                                   <asp:ListItem Text="As Location" Value="1"></asp:ListItem>
                                   </asp:DropDownList>  
                            </div>
                        </div>
                                <!--SECOND-FOLD-->
                    ...
                    <div class="report" style="overflow-x:Auto; width:100%;">
                        ...
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand"  OnRowDataBound="grdMain_RowDataBound" >
                            <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="As Location" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150">
                                                <HeaderStyle HorizontalAlign="Center" Width="150px" />
                                                <ItemStyle HorizontalAlign="Center" Width="150" />
                                                <ItemTemplate>
                                                <asp:Label ID="lblLoc" runat="server" Text='<%#Eval("AsLoc")%>'></asp:Label>
                                  ...
                                  <asp:TemplateField HeaderText="Status" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="30">
                                                ...
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgBtnStatus" runat="server" Width="15px" Height="15px" CommandArgument='<%#Eval("CityIdno")+"_"+Eval("Status") %>'
                                  ...
                                  <asp:TemplateField HeaderText="Action" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemStyle HorizontalAlign="Center" Width="50" />
                                                <ItemTemplate>
                                                  <asp:LinkButton ID="lnkbtnEdit" CssClass="edit" runat="server" CommandArgument='<%#Eval("CityIdno") %>' CommandName="cmdedit" TabIndex="5" ToolTip="Click to edit"><i class="fa fa-edit icon"></i></asp:LinkButton>
                                          
                                                 <asp:LinkButton ID="lnkbtnDelete" CssClass="delete" runat="server" CommandArgument='<%#Eval("CityIdno") %>' OnClientClick="return confirm('Do you want to delete this record ?');" CommandName="cmddelete" TabIndex="6" ToolTip="Click to delete"><i class="fa fa-trash-o"></i></asp:LinkButton>                                               
                                                </ItemTemplate>
                                            </asp:TemplateField>
                            </Columns>
