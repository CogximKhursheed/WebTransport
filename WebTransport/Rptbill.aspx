<%@ Page Language="C#" AutoEventWireup="true"  CodeBehind="Rptbill.aspx.cs" Inherits="WebTransport.Rptbill" %>
 ...
 <div id="print" runat="server" >
    <table width="100%" cellpadding="5" cellspacing="0" align="center" style="font-family: arial; font-size: 12px; border-collapse: collapse;">
        <tbody>
            ...
            <tr>
                <td align="center" colspan="10" style="font-size: 17px;border: 1px solid;border-bottom: none;"><asp:Label ID="lblCompAdd1" runat="server"></asp:Label>, <asp:Label ID="lblcity" runat="server"></asp:Label>(<asp:Label ID="lblpin" runat="server"></asp:Label>)<br>STATE:- <asp:Label ID="lblstate" runat="server"></asp:Label><br>MOBILE NO.:-<asp:Label ID="lblmobile" runat="server"></asp:Label></td>
            </tr>
            <%--<tr>
             ...
             <tr>
                ...
                <td colspan="4" style="border: 1px solid;text-align: right;">SAC CODE:- 767858980<asp:Label ID="lblhsn" runat="server"></asp:Label></td>
            </tr>
            <tr>
    ...
    <table width="100%" cellpadding="5" cellspacing="0" align="center" style="font-family: arial; font-size: 12px; border-collapse: collapse;">
     ...
     <ItemTemplate>
      ...
      <FooterTemplate>
            ...
            <tr>
                ...
                <th style="border: 1px solid;"> <asp:Label ID="lbltotqty" runat="server"></asp:Label></th>
     ...
     <table width="100%" cellpadding="5" cellspacing="0" align="center" style="font-family: arial; font-size: 12px; border-collapse: collapse;">
        <thead>  
           ...
           <HeaderTemplate>
                <th width="5%" align="center" style="border: 1px solid;">Toll Amnt.</th>
                <th style="border: 1px solid;">SONWARI</th>
                <th style="border: 1px solid;">TICKET NO.</th>
                <th style="border: 1px solid;">ICHOUL</th>
                <th style="border: 1px solid;">TICKET NO.</th>
                <th style="border: 1px solid;">KHOKHRAJ</th>
                <th style="border: 1px solid;">TICKET NO.</th>  
                  </HeaderTemplate>   
                   <ItemTemplate>
        <tbody>
