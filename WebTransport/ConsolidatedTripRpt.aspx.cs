...
{
    public partial class ConsolidatedTripRpt : Pagebase
    {
        #region Variable ...
        string conString = "";
        ...
        private void BindGrid()
        {
            ...
            FPurNetTot = 0;
            FVchrNetTot = 0;
            ConsolidatedTripRptDAL obj = new ConsolidatedTripRptDAL();
            ...
            if (list != null && list.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < list.Rows.Count; i++)
                {
                    ...
                    if (list.Rows.Count == 1) // Only If List Have Single Record
                    {
                        ...
                        Dr["Acnt_Name"] = Convert.ToString("Challan Total");
                        Dr["Chln_No"] = "Freight";
                        Dr["Gr_Date"] = "Adv. Amnt";
                    ...
                    if (i == list.Rows.Count - 1)
                    {
                        ...
                        if (DtTrip != null && DtTrip.Rows.Count > 0)
                        {
                            ...
                            FTripNetTot += (Convert.ToDouble(DtChild.Rows[DtChild.Rows.Count - 2]["Net_Amnt"]) + Convert.ToDouble(DtTrip.Rows[0]["InseAmnt"])) - (Convert.ToDouble(DtTrip.Rows[0]["FuelAmnt"]) + Convert.ToDouble(DtTrip.Rows[0]["TollAmnt"]) + Convert.ToDouble(DtTrip.Rows[0]["ExpAmnt"]));
                            DrrT["Net_Amnt"] = ((Convert.ToDouble(DtChild.Rows[DtChild.Rows.Count - 2]["Net_Amnt"]) + Convert.ToDouble(DtTrip.Rows[0]["InseAmnt"])) - (Convert.ToDouble(DtTrip.Rows[0]["FuelAmnt"]) + Convert.ToDouble(DtTrip.Rows[0]["TollAmnt"]) + Convert.ToDouble(DtTrip.Rows[0]["ExpAmnt"]))).ToString("N2");
                        }
                    ...
                    if (PrvTripId != Convert.ToInt32(list.Rows[i + 1]["Trip_Idno"]))
                    {
                        ...
                        if (DtTrip != null && DtTrip.Rows.Count > 0)
                        {
                            ...
                            FTripNetTot += (Convert.ToDouble(DtChild.Rows[DtChild.Rows.Count - 2]["Net_Amnt"]) + Convert.ToDouble(DtTrip.Rows[0]["InseAmnt"])) - (Convert.ToDouble(DtTrip.Rows[0]["FuelAmnt"]) + Convert.ToDouble(DtTrip.Rows[0]["TollAmnt"]) + Convert.ToDouble(DtTrip.Rows[0]["ExpAmnt"]));
                            DrrT1["Net_Amnt"] = ((Convert.ToDouble(DtChild.Rows[DtChild.Rows.Count - 2]["Net_Amnt"]) + Convert.ToDouble(DtTrip.Rows[0]["InseAmnt"])) - (Convert.ToDouble(DtTrip.Rows[0]["FuelAmnt"]) + Convert.ToDouble(DtTrip.Rows[0]["TollAmnt"]) + Convert.ToDouble(DtTrip.Rows[0]["ExpAmnt"]))).ToString("N2");
