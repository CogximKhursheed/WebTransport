<%@ Page Title="Trip Expense Report" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" EnableEventValidation="false" CodeBehind="TripExpnsReport.aspx.cs"
    Inherits="WebTransport.TripExpnsReport" %>
                            ...
                            <div class="filter" style="width: 400px; display: none;">
                                <div class="panel-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6 pull-left">
                                            <div class="control-holder full-width">
                                                <span class="filter-label">Expense</span>
                                            </div>
                                            <div class="control-holder full-width">
                                                <asp:DropDownList ID="drpExpense" runat="server" CssClass="form-control"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 pull-left">
                                            <div class="control-holder full-width">
                                            ...
                                            <div class="control-holder full-width">
                                                <asp:DropDownList ID="ddlTruckNo" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlTruckNo_SelectedIndexChanged"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 pull-left">
                                            <div class="control-holder full-width">
                                ...
                                <div id="divPrint">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" BorderStyle="None" CssClass="u-table u-table-green u-table-stripped fixed-header-table bold-last-row row-selection no-wrap-cell" GridLines="None" BorderWidth="0" ShowFooter="true" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" OnRowDataBound="grdMain_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Expense Name" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="Left">
                                                <ItemStyle HorizontalAlign="Left" Width="50" />
                                                <ItemTemplate>
                                                    <%#Eval("ExpName")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Expense Amnt" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                <ItemStyle HorizontalAlign="right" Width="70" />
                                                <ItemTemplate>
