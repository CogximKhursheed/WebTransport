<%@ Page Title="Trip Sheet Report" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" EnableEventValidation="false" CodeBehind="TripReport.aspx.cs"
    Inherits="WebTransport.TripReport" %>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6 pull-left">
                                            ...
                                            <div class="control-holder full-width">
                                                <asp:TextBox ID="txtDateFrom" runat="server" CssClass="input-sm datepicker form-control" MaxLength="6" data-date-format="dd-mm-yyyy"></asp:TextBox>
                                        ...
                                        <div class="col-sm-6 pull-left">
                                            <div id="ctl00_ContentPlaceHolder1_UpdatePanel3">
                                                ...
                                                <div class="control-holder full-width">
                                                    <asp:TextBox ID="txtDateTo" runat="server" CssClass="input-sm datepicker form-control" MaxLength="50" data-date-format="dd-mm-yyyy"></asp:TextBox>
                                        ...
                                        <div class="col-sm-6 pull-left">
                                            <div class="control-holder full-width">
                                                <span class="filter-label">Trip No.</span>
                                            </div>
                                            <div class="control-holder full-width">
                                                <asp:TextBox ID="txtTripNo" runat="server" CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div id="divPrint">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" BorderStyle="None" CssClass="u-table u-table-green u-table-stripped fixed-header-table bold-last-row row-selection no-wrap-cell" GridLines="None" BorderWidth="0" ShowFooter="true" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" OnRowDataBound="grdMain_RowDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Trip No." HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="Right">
                                                <ItemStyle HorizontalAlign="Right" Width="70" />
                                                <ItemTemplate>
                                                    <%#Eval("Trip_No")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Trip Date" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="Center">
                                                <ItemStyle HorizontalAlign="Center" Width="80" />
                                                <ItemTemplate>
                                                    <%#Eval("Trip_Date").ToString()%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Kms" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="right">
                                            ...
                                            <asp:TemplateField HeaderText="Advance Amnt" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                <ItemStyle HorizontalAlign="right" Width="70" />
                                                <ItemTemplate>
                                                ...
                                                <FooterTemplate>
                                                    <b>
                                                        <asp:Label ID="lblAdvAmnt" runat="server"></asp:Label></b>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Diesel Amnt" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                ...
                                                <FooterTemplate>
                                                    <b>
                                                        <asp:Label ID="lblDieselAmnt" runat="server"></asp:Label></b>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Incentive" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                <ItemStyle HorizontalAlign="right" Width="70" />
                                                <ItemTemplate>
                                                    <%#(string.IsNullOrEmpty(Convert.ToString(Eval("Insentive_Amnt"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("Insentive_Amnt")))))%>
                                                </ItemTemplate>
                                                <FooterStyle HorizontalAlign="right" />
                                                <FooterTemplate>
                                                    <b>
                                                        <asp:Label ID="lblIncAmnt" runat="server"></asp:Label></b>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Chln. Amnt" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                <ItemStyle HorizontalAlign="right" Width="70" />
                                                <ItemTemplate>
                                                    <%#(string.IsNullOrEmpty(Convert.ToString(Eval("Chln_NetAmnt"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("Chln_NetAmnt")))))%>
                                                </ItemTemplate>
                                                <FooterStyle HorizontalAlign="right" />
                                                <FooterTemplate>
                                                    <b>
                                                        <asp:Label ID="lblChlnTot" runat="server"></asp:Label></b>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Fuel Amnt" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                <ItemStyle HorizontalAlign="right" Width="70" />
                                                <ItemTemplate>
                                                    <%#(string.IsNullOrEmpty(Convert.ToString(Eval("Fuel_Amnt"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("Fuel_Amnt")))))%>
                                                </ItemTemplate>
                                                <FooterStyle HorizontalAlign="right" />
                                                <FooterTemplate>
                                                    <b>
                                                        <asp:Label ID="lblFuelTot" runat="server"></asp:Label></b>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Expn. Amnt" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                <ItemStyle HorizontalAlign="right" Width="70" />
                                                <ItemTemplate>
                                                    <%#(string.IsNullOrEmpty(Convert.ToString(Eval("Exp_Amnt"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("Exp_Amnt")))))%>
                                                </ItemTemplate>
                                                <FooterStyle HorizontalAlign="right" />
                                                <FooterTemplate>
                                                    <b>
                                                        <asp:Label ID="lblExpAmnt" runat="server"></asp:Label></b>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Toll Amnt" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                <ItemStyle HorizontalAlign="right" Width="70" />
                                                <ItemTemplate>
                                                    <%#(string.IsNullOrEmpty(Convert.ToString(Eval("Toll_Amnt"))) ? "0.00" : (string.Format("{0:0,0.00}", Convert.ToDouble(Eval("Toll_Amnt")))))%>
                                                </ItemTemplate>
                                                <FooterStyle HorizontalAlign="right" />
                                                <FooterTemplate>
                                                    <b>
                                                        <asp:Label ID="lblTollAmnt" runat="server"></asp:Label></b>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                        </Columns>
