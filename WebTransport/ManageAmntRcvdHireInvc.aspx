<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="ManageAmntRcvdHireInvc.aspx.cs" EnableEventValidation="false" Inherits="WebTransport.ManageAmntRcvdHireInvc" %>
    ...
    <div class="center-block" style="width: 100%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Amount Received Invoice List [Own to hire]</h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="AmntAgainstInvoiceOTH.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
