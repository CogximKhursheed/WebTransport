<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RptCustomTripSheet.aspx.cs" Inherits="WebTransport.RptCustomTripSheet" %>
    ...
    <div class="center-block" style="width: 100%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Custom Trip Sheet List </h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="CustomTripSheet.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="report" style="overflow-x:Auto; width:100%;">
                        ...
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" OnRowDataBound="grdMain_RowDataBound">
                            <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="Trip No." HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100">
                                  ...
                                  <asp:TemplateField HeaderText="Pref No." HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100">
                                                <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                                <ItemStyle HorizontalAlign="Center" Width="100" />
                                                <ItemTemplate>
                                                    <%#Eval("Pref_No")%>
                                  ...
                                  <asp:TemplateField HeaderText="Trip Date" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="100">
                                  ...
                                  <asp:TemplateField HeaderText="Start KM" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100">
                                                <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                                <ItemStyle HorizontalAlign="Center" Width="100" />
                                                <ItemTemplate>
                                              <%#Convert.ToDouble(string.IsNullOrEmpty(Convert.ToString(Eval("StartKms"))) ? "0" : (Convert.ToDouble((Eval("StartKms"))).ToString("N2")))%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                  <asp:TemplateField HeaderText="End KM" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100">
                                                <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                                <ItemStyle HorizontalAlign="Center" Width="100" />
                                                <ItemTemplate>
                                                <%#Convert.ToDouble(string.IsNullOrEmpty(Convert.ToString(Eval("EndKms"))) ? "0" : (Convert.ToDouble((Eval("EndKms"))).ToString("N2")))%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                  ...
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="100" HeaderText="Lane">
                                  ...
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="50" HeaderText="Vehicle Size">
                                  ...
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="100" HeaderText="Milage">
                                                <HeaderStyle HorizontalAlign="Right" Width="100px" />
                                                <ItemStyle HorizontalAlign="Right" Width="100" />
                                                <ItemTemplate>
                                                   <%#Eval("Milage")%>
                                  ...
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="100" HeaderText="Card Name">
                                                <HeaderStyle HorizontalAlign="Right" Width="100px" />
                                                <ItemStyle HorizontalAlign="Right" Width="100" />
                                                <ItemTemplate>
                                                   <%#Eval("DSL_Card_Name")%>
                                  ...
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="100" HeaderText="Card No.">
                                                <HeaderStyle HorizontalAlign="Right" Width="100px" />
                                                <ItemStyle HorizontalAlign="Right" Width="100" />
                                                <ItemTemplate>
                                                   <%#Eval("DSL_Card_Number")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="50" HeaderText="DSL Qty">
                                                <HeaderStyle HorizontalAlign="Right" Width="50px" />
                                                <ItemStyle HorizontalAlign="Right" Width="50" />
                                                <ItemTemplate>
                                                   <%#Eval("DSL_Qty")%>
                                  ...
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="50" HeaderText="DSL Rate">
                                                <HeaderStyle HorizontalAlign="Right" Width="50px" />
                                                <ItemStyle HorizontalAlign="Right" Width="50" />
                                                <ItemTemplate>
                                                   <%#Eval("DSL_Rate")%>
                                  ...
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="100" HeaderText="DSL Card Amnt.">
                                                <HeaderStyle HorizontalAlign="Right" Width="100px" />
                                                <ItemStyle HorizontalAlign="Right" Width="100" />
                                                <ItemTemplate>
                                                   <%#Eval("DSL_Card_Amt")%>
                                  ...
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="100" HeaderText="Total DSL Qty">
                                                <HeaderStyle HorizontalAlign="Right" Width="100px" />
                                                <ItemStyle HorizontalAlign="Right" Width="100" />
                                                <ItemTemplate>
                                                   <%#Eval("Total_DSL_Qty")%>
                                  ...
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="100" HeaderText="Total DSL Amnt.">
                                                <HeaderStyle HorizontalAlign="Right" Width="100px" />
                                                <ItemStyle HorizontalAlign="Right" Width="100" />
                                                <ItemTemplate>
                                                   <%#Eval("Total_DSL_Amt")%>
                                  ...
                                  <asp:TemplateField HeaderStyle-HorizontalAlign="Right" HeaderStyle-Width="100" HeaderText="Net Amount">
                                                ...
                                                <ItemStyle HorizontalAlign="Right" Width="100" />
                                                <ItemTemplate>
                                                    <%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("Total_Amt")))%>
                                                </ItemTemplate>
