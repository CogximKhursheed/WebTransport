<%@ Page Title="DELIVERY CHALLAN REPORT" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="DeliveryChallanRpt.aspx.cs" EnableEventValidation="false" Inherits="WebTransport.DeliveryChallanRpt" %>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6 pull-left">
                                            ...
                                            <div class="control-holder full-width">
                                                <asp:DropDownList ID="drpCityDelivery" runat="server" CssClass="form-control"></asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 pull-left">
                                            <div class="control-holder full-width">
                                                <span class="filter-label">Challan No</span>
                                            </div>
                                            <div class="control-holder full-width">
                                                <asp:TextBox ID="txtChlnNo" runat="server" PlaceHolder="Challan Number" CssClass="form-control" MaxLength="50"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <td>
                                                <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" BorderStyle="None" CssClass="u-table u-table-green u-table-stripped fixed-header-table bold-last-row row-selection no-wrap-cell" GridLines="None" BorderWidth="0" ShowFooter="true" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowDataBound="grdMain_RowDataBound">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Challan Date" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="Center">
                                                        ...
                                                        <asp:TemplateField HeaderText="Transporter" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemStyle HorizontalAlign="Left" Width="80" />
                                                            <ItemTemplate>
                                                                <%#Eval("Acnt_Name")%>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Gross Amount" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="right">
                                                        ...
                                                        <asp:TemplateField HeaderText="Katt Amount" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="50" />
                                                            <ItemTemplate>
                                                            ...
                                                            <FooterTemplate>
                                                                <b>
                                                                    <asp:Label ID="lblKattAmnt" runat="server"></asp:Label></b>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Other Amount" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="50" />
                                                            <ItemTemplate>
                                                            ...
                                                            <FooterTemplate>
                                                                <b>
                                                                    <asp:Label ID="lblOtherAmnt" runat="server"></asp:Label></b>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Net Amount" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="50" />
                                                            <ItemTemplate>
