<%@ Page Title="Trial Balance Report" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" CodeBehind="AccTrailBal.aspx.cs" Inherits="WebTransport.AccTrailBal" %>
                            ...
                            <div class="col-sm-4">
                                <div class="title-action">
                                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                        <ContentTemplate>
                                            <div id="view_print" runat="server" visible="false">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6 pull-left">
                                            ...
                                            <div class="control-holder full-width">
                                                <asp:DropDownList ID="ddlTB" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlTB_SelectedIndexChanged">
                                                    <asp:ListItem Value="0">Group Wise</asp:ListItem>
                                                    <asp:ListItem Value="1">Ledger Wise</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 pull-left">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="control-holder full-width">
                                                <div class="trial-bal-checkbox" style="height: 170px">
                                                    <div id="chklist" runat="server">
                                                        <a id="A3" href="#" onclick="javascript: CheckBoxListSelect ('<%= chkIemModel.ClientID %>',true)">
                                                            <font color="Black">Check All</font></a> | <a id="A4" href="#" onclick="javascript: CheckBoxListSelect ('<%= chkIemModel.ClientID %>',false)">
                                                                <font color="Black">Uncheck All</font></a>
                                                    </div>
                                                    <asp:CheckBoxList ID="chkIemModel" BorderStyle="Double" CssClass="check" BorderWidth="3px" Width="100%" runat="server">
                                                    </asp:CheckBoxList>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="ibox-content auto-form-height scroll-pane">
                            <div class="table-responsive nowrap dataTable slim-scrollbar fixed-header-table-scroll" style="max-height: calc(100vh - 230px);">
                                <div id="divPrint">
                                    <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" BorderStyle="None" CssClass="u-table u-table-green u-table-stripped fixed-header-table bold-last-row row-selection no-wrap-cell" GridLines="None" BorderWidth="0" ShowFooter="true" AllowPaging="false" PageSize="25" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowDataBound="grdMain_RowDataBound" OnRowCommand="grdMain_RowCommand">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Op.Debit" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                ...
                                                <FooterTemplate>
                                                    <b>
                                                        <asp:Label ID="lbl8TODebit" runat="server"></asp:Label></b>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Op.Credit" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="right">
                                                <ItemStyle HorizontalAlign="right" Width="70" />
                                                <ItemTemplate>
                                                ...
                                                <FooterTemplate>
                                                    <b>
                                                        <asp:Label ID="lbl9TOCredit" runat="server"></asp:Label></b>
                                                </FooterTemplate>
                                            </asp:TemplateField>
                                ...
                                <div style="float: left;">
                                    <asp:CheckBox ID="chkYearOpng" Text="Display Year Opening Bal. only" AutoPostBack="true" CssClass="check"
                                        runat="server" Visible="false"
                                        OnCheckedChanged="chkYearOpng_CheckedChanged" />
                                </div>
                            </div>
                            <div class="col-sm-12">
