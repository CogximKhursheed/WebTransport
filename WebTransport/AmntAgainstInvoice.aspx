<%@ Page Title="Amount Received Against Invoice" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" CodeBehind="AmntAgainstInvoice.aspx.cs" Inherits="WebTransport.AmntAgainstInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row ">
        ...
        <div class="col-lg-10">
            <section class="panel panel-default full_form_container quotation_master_form">
                <header class="panel-heading font-bold form_heading">AMOUNT RECEIVED AGAINST INVOICE
                <span class="view_print"><a href="ManageAmntRcvdInvc.aspx"><asp:Label ID="lblViewList" runat="server" Text="LIST"></asp:Label></a>&nbsp;
                      ...
                      <section class="panel panel-in-default">  
                        <div class="panel-body">
                            ...
                            <div class="col-sm-4">
                              ...
                              <div class="col-sm-9" style="width: 63%;">
                                <asp:DropDownList ID="ddlFromCity" runat="server" CssClass="form-control" 
                                    TabIndex="4" Width="180px" OnSelectedIndexChanged="ddlFromCity_SelectedIndexChanged"
                                    AutoPostBack="true">
                                </asp:DropDownList>
                          ...
                          <div class="clearfix even_row">
                            <div class="col-sm-4">
                              <label class="col-sm-3 control-label" style="width: 29%;">Party Name<span class="required-field">*</span></label>
                              <div class="col-sm-8" style="width: 60%;">
                                <asp:DropDownList ID="ddlPartyName" runat="server" AutoPostBack="True" CssClass="chzn-select" style="width: 100%;"
                                  TabIndex="5" Width="190px" OnSelectedIndexChanged="ddlPartyName_SelectedIndexChanged1">
                                </asp:DropDownList>
                              ...
                              <div class="col-sm-1" style="width: 10%;">
                           	...
                           	<div class="col-sm-3" style="width:34%">
                           		<label class="col-sm-3 control-label" style="width: 28%;">Rcpt. Type<span class="required-field">*</span></label>
                            ...
                            <div class="col-sm-4">
                              ...
                              <div class="col-sm-8" style="width: 71%;">
                               <%-- <asp:DropDownList ID="ddlCustmerBank" runat="server" CssClass="form-control" 
                                  ...
                                  <asp:HiddenField ID="hidCustBankID" runat="server" />
                                  	<asp:TextBox ID="txtCustomerBank" runat="server" CssClass="form-control" ></asp:TextBox>
                            <%--        <asp:TextBox ID="txtCustomerBank" runat="server" CssClass="glow form-control auto-extender" onkeyup="SetContextKey()" onkeydown="return (event.keyCode!=13);" TabIndex="5"></asp:TextBox>--%>
                                   <%--  <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txtCustomerBank" MinimumPrefixLength="1" UseContextKey="false" EnableCaching="true" CompletionSetCount="1" CompletionInterval="500" OnClientItemSelected="ClientItemSelected" ServiceMethod="GetCustomerBank">
                          ...
                          <section class="panel panel-in-default">                            
                            <div class="panel-body" style="overflow: auto">     
                               <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" BorderStyle="None" CssClass="display nowrap dataTable"
                                        ...
                                        OnRowDataBound="grdMain_RowDataBound" ViewStateMode="Enabled" PageSize="30" ClientIDMode="Static">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Receiver Name" HeaderStyle-Width="150" HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:HiddenField ID="hidGrIdno" runat="server" Value='<%#Eval("Inv_Idno")%>' />
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="TDS Amount" HeaderStyle-Width="60" HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtTdsAmnt" TabIndex="12" runat="server" Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("TDS_Amnt")))%>'
                                                    OnTextChanged="txt_txtTdsAmnt" CssClass="tds" AutoPostBack="true" EnableViewState="true" ViewStateMode="Enabled"
                                                    Width="60px"></asp:TextBox>
                                            </ItemTemplate>
                                            <FooterStyle HorizontalAlign="Right" />
                                            <FooterTemplate>
                                                <span id="TotValTDS"></span>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="TDS Rcvd." HeaderStyle-Width="60" HeaderStyle-HorizontalAlign="Left">
                                            <HeaderStyle HorizontalAlign="Right" Width="60px" />
                                            <ItemStyle Width="60" HorizontalAlign="Right" />
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtTdsRcvd" TabIndex="12" runat="server" Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("TDS_Amnt")))%>'
                                                    OnTextChanged="txt_txtTdsRcvd" CssClass="tds" AutoPostBack="true" EnableViewState="true" ViewStateMode="Enabled"
                                                    Width="60px"></asp:TextBox>
                                            </ItemTemplate>
                                            <FooterStyle HorizontalAlign="Right" />
                                            <FooterTemplate>
                                                <span id="TotValTDSRcvd"></span>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Debit Note" HeaderStyle-Width="60" HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtDebitNote" TabIndex="13"  runat="server" Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("Dr_Note")))%>'
                                                    OnTextChanged="txt_txtDebitNote" AutoPostBack="true" CssClass="debit" EnableViewState="true" ViewStateMode="Enabled"
                                                    Width="60px"></asp:TextBox>
                                            </ItemTemplate>
                                            <FooterStyle HorizontalAlign="Right" />
                                            <FooterTemplate>
                                                <span id="TotValDebit"></span>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Recv.Amount" HeaderStyle-Width="80" HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtRcvdAmnt" TabIndex="14" runat="server" Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("Recv_Amount")))%>'
                                                    OnTextChanged="txt_txtRcvdAmnt" AutoPostBack="true" CssClass="rec" EnableViewState="true" ViewStateMode="Enabled"
                                                    Width="75px"></asp:TextBox>
                                            </ItemTemplate>
                                            <FooterStyle HorizontalAlign="Right" />
                                            <FooterTemplate>
                                                <span id="TotValRec"></span>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Ref No(Vchr)" HeaderStyle-Width="110" HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <div style="float:left;">
                                                <asp:TextBox ID="txtRefNo" runat="server" TabIndex="15" Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("Vchr_Amnt")))%>'
                                                    EnableViewState="true" ViewStateMode="Enabled" CssClass="ref" Enabled="false" Width="60px" AutoPostBack="True"
                                        ...
                                        <asp:TemplateField HeaderText="Due" HeaderStyle-Width="60" HeaderStyle-HorizontalAlign="Center">
                                            ...
                                            <ItemStyle Width="60" HorizontalAlign="Right" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblDue" runat="server" CssClass="due" Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("Tot_Recvd")))%>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterStyle HorizontalAlign="Right" />
                                            <FooterTemplate>
                                                <span id="TotValDue"></span>
                                            </FooterTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                    </asp:GridView>
                ...
                <div class="clearfix odd_row">
                        ...
                        <div class="col-sm-3">
                          ...
                          <div class="col-sm-3" id= "divPosting" runat="server">
						...
						<div id="gr_details_form" class="modal fade">
							...
							<div class="panel-body">
	                            ...
	                            <div class="col-sm-6">
                                    ...
                                    <div class="col-sm-8">
                                        <asp:DropDownList ID="ddlFromLoc" CssClass="form-control" runat="server"></asp:DropDownList>
                                    </div>
	                            </div>
    ...
    <div id="Vchr_Details" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="popform_header">Voucher Details</h4>
                </div>
                <div class="modal-body">
                    <section class="panel panel-default full_form_container material_search_pop_form">
			            <div class="panel-body">
                ...
                <td>
                    <table border="0" cellspacing="0" style="font-size: 12px" width="100%" id="Table5">
                        <tr>
                            ...
                            <td class="white_bg" width="5%" align="center"></td>
                        ...
                        <tr>
                            <td class="white_bg" colspan="9" width="15%"></td>
                        </tr>
                        <tr>
                            <td colspan="7">
                                <table align="left" width="100%">
                                    <tr>
                                        ...
                                        <td class="white_bg" width="15%" align="right" colspan="2"></td>
                                        <td class="white_bg" width="20%" align="right" colspan="2"></td>
    ...
    <div id="acc_posting" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <div class="popup_footer_btn">
                        <asp:LinkButton ID="lnkbtnAccPosting" OnClick="lnkbtnAccPosting_Click" ValidationGroup="Acc" class="btn btn-dark"
                            runat="server">Acc Posting</asp:LinkButton>
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterScriptPlaceHolder" runat="server">
    ...
    <script>
        ...
        function AddAll() {
            ...
            var sumDue = 0;
            $('.tds').each(function () {
                sumTDS = sumTDS + parseFloat($(this).val().replace(",", ""));
            });
            $('.debit').each(function () {
                sumDebit = sumDebit + parseFloat($(this).val().replace(",", ""));
            });
            $('.rec').each(function () {
                sumRec = sumRec + parseFloat($(this).val().replace(",", ""));
            });
            $('.ref').each(function () {
                sumRef = sumRef + parseFloat($(this).val().replace(",", ""));
            });
            $('.due').each(function () {
                sumDue = sumDue + parseFloat($(this).text().replace(",", ""));
            });

            $('#TotValTDS').text(commaSeparateNumber(sumTDS.toFixed(2)));
            $('#TotValDebit').text(commaSeparateNumber(sumDebit.toFixed(2)));
            $('#TotValRec').text(commaSeparateNumber(sumRec.toFixed(2)));
            $('#TotValRef').text(commaSeparateNumber(sumRef.toFixed(2)));
            $('#TotValDue').text(commaSeparateNumber(sumDue.toFixed(2)));
        }
  ...
  <%--  <script type="text/javascript">
        function ClientItemSelected(sender, e) {
            $get("<%=hidCustBankID.ClientID %>").value = e.get_value();
        }
    </script>--%>
