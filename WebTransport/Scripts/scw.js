...
//******************************************************************************
    ...
    // alternatively, hard code a date like this...
          var scwBaseYear = 2011;

   // var scwBaseYear        = scwDateNow.getFullYear()-10;

    // How many years do want to be valid and to show in the drop-down list?
	var temp_list=parseInt(scwDateNow.getFullYear())-parseInt(scwBaseYear);
	//alert(temp_list);
    var scwDropDownYears   = temp_list+15;
    ...
    document.writeln(
        '<style type="text/css">'                                       +
            ...
            '/* Calendar background */'                                 +
            'table.scw                  {background-color:  #4388D5;}'  +
            '/* Drag Handle */'                                         +
            ...
            'td.scwCellsExMonth         {background-color:  #CCCCCC;'   +
                                        'color:             #666666;}'  +
            '/* Today selector */'                                      +
            'td.scwNow                  {background-color:  #4388D5;'   +
                                        'color:             #FFFFFF;}'  +
            '/* Clear Button */'                                        +
