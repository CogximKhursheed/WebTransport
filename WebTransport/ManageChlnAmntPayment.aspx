<%@ Page Title="Manage Party Payment Against Challan" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" CodeBehind="ManageChlnAmntPayment.aspx.cs" EnableEventValidation="false"
    Inherits="WebTransport.ManageChlnAmntPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="center-block" style="width: 100%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Party Payment Challan  List </h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="ChlnAmntPayment.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
            <div class="ibox-content">
                <div class="">
                            ...
                            <div class="control-holder full-width">
                                 <asp:DropDownList ID="ddlSender" Visible="false" runat="server" CssClass="chzn-select" style="width:100%;"></asp:DropDownList>
                                <asp:TextBox ID="txtParty" runat="server" CssClass="glow form-control auto-extender" onkeyup="SetContextKey()" onkeydown="return (event.keyCode!=13);" ></asp:TextBox>
                                <asp:AutoCompleteExtender ID="AutoCompleteExtender1" runat="server" TargetControlID="txtParty" MinimumPrefixLength="1" UseContextKey="false" EnableCaching="true" CompletionSetCount="1" CompletionInterval="500" OnClientItemSelected="ClientItemSelected" ServiceMethod="GetPartyNo"></asp:AutoCompleteExtender>
                            </div>
                        </div>
                                <!--SECOND-FOLD-->
                                <div class="col-sm-12 no-pad">
                    ...
                    <div class="report" style="overflow-x:Auto; width:100%;">
                        ...
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None" AllowPaging="true" PageSize="35"  OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" OnRowDataBound="grdMain_RowDataBound"   OnRowCreated="grdMain_RowCreated">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150" HeaderText="Party Name">
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="100" HeaderText="Recipt Name">
                                                <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                                <ItemStyle HorizontalAlign="Left" Width="50" />
                                                <ItemTemplate>
                                                    <%#Eval("ReciptName")%>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="100" HeaderText="Recipt No">
                                                <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                                <ItemStyle HorizontalAlign="Left" Width="50" />
                                                <ItemTemplate>
                                                    <%#string.IsNullOrEmpty(Convert.ToString(Eval("Inst_No"))) ? "" : Convert.ToString(Eval("Inst_No"))%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="100" HeaderText="Recipt Date">
                                                <HeaderStyle HorizontalAlign="Left" Width="100px" />
                                                <ItemStyle HorizontalAlign="Left" Width="50" />
                                                <ItemTemplate>
                                                    <%#string.IsNullOrEmpty(Convert.ToString(Eval("Inst_Dt"))) ? "" : Convert.ToDateTime(Eval("Inst_Dt")).ToString("dd-MM-yyyy")%>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderStyle-CssClass="gridHeaderAlignRight" HeaderStyle-Width="100" HeaderText="Net Amount">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblTotRecvd" runat="server" Text='<%#String.Format("{0:0,0.00}", Convert.ToDouble(Eval("Net_Amnt")))%>'></asp:Label>
                                                </ItemTemplate>
                                                <FooterStyle Font-Bold="true" ForeColor="Black" HorizontalAlign="Right" />
                                                <FooterTemplate>
                                    ...
                                    <asp:Label ID="LblNoRecordFound" Text="Record(s) not found." runat="server" CssClass="white_bg"></asp:Label>
                                       ...
                                       <div class="secondFooterClass"  id="divpaging" runat="server" visible="false">                                                                           
                                        <table class="" id="tblFooterscnd" runat="server" >
		                                  <tr><th rowspan="1" colspan="1" style="width:190px;"> <asp:Label ID="lblcontant" runat="server"></asp:Label></th><th rowspan="1" colspan="1" style="width: 110px;"></th><th rowspan="1" colspan="1" style="width: 175px;text-align:right;">Total</th><th rowspan="1" colspan="1" style="width: 110px;padding-left:85px;"><asp:Label ID="lblNetTotalAmount" runat="server"></asp:Label>
    ...
    <%--hidden fields--%>
    <asp:HiddenField ID="hfPartyNoId" runat="server" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="FooterScriptPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        function ClientItemSelected(sender, e) {
            $get("<%=hfPartyNoId.ClientID %>").value = e.get_value();
        }
    </script>
</asp:Content>
