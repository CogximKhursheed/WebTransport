...
{
    public partial class PartyDetailReportArv : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["DBName"] != null)
                if (Session["DBName"].ToString() == "TrACMPLLive" || Session["DBName"].ToString() == "TrAGTCLive" || Session["DBName"].ToString() == "TrAravali1819")// || Session["DBName"].ToString() == "TrRawatMotorCoNasiraba"
                { }
                else
        ...
        protected void imgBtnExcel_Click(object sender, ImageClickEventArgs e)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                dt.Columns.Remove("TotalFreight");
                dt.Columns.Remove("BalanceAmount");
                dt.Columns.Remove("ReceivedAmnt");
                dt.Columns.Remove("BalanceAmountWithShortage");
                Export(dt);
            }
        }
        ...
        public void BindGrid()
        {
            ...
            Ds = obj.SelectPartyDetailReportArv(DateFrom, DateTo, PartyID, ApplicationFunction.ConnectionString());
            if (Ds != null && Ds.Tables.Count > 0 && Ds.Tables[0].Rows.Count > 0)
            {
                ...
                lblTotalRecord.Text = "Total Recods: " + Ds.Tables[0].Rows.Count.ToString();
            }
            else
            {
