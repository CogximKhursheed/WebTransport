<%@ Page Title="Manage Account Sub Group" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" CodeBehind="ManageAcntSubGrpMaster.aspx.cs" EnableEventValidation="false"
    Inherits="WebTransport.ManageAcntSubGrpMaster" %>
    ...
    <div class="center-block" style="width: 50%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Account Sub Group List </h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="AcntSubGrpMaster.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
            <div class="ibox-content">
                 <div class="">
                            ...
                            <div class="control-holder full-width">
                                <asp:DropDownList ID="drpAGrp" runat="server" CssClass="form-control backlight"></asp:DropDownList>
                                  <asp:RequiredFieldValidator ID="rfvAGrp" runat="server" ControlToValidate="drpAGrp" ValidationGroup="Save" ErrorMessage="Please Select Account Group!" CssClass="classValidation" SetFocusOnError="true" Display="Dynamic" InitialValue="0"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                                <div class="col-sm-6 no-pad">
                            <div class="control-label"> 
                                <span>A/C Sub Group</span>
                            </div>
                            <div class="control-holder full-width">
                                <asp:TextBox ID="txtAcntSubGrp" placeholder="Sub Group Name" runat="server" CssClass="form-control backlight" MaxLength="50"></asp:TextBox>                            
                            </div>
                        </div>
                                <!--SECOND-FOLD-->
                                <div class="col-sm-12 no-pad">
                    ...
                    <div class="report" style="overflow-x:Auto; width:100%;">
                        ...
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" onrowdatabound="grdMain_RowDataBound" >
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Account Group" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150">
                                ...
                                <asp:TemplateField HeaderText="Account Sub Group" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150">
                                                <HeaderStyle HorizontalAlign="Left" Width="150px" />
                                                <ItemStyle HorizontalAlign="Left" Width="150" />
                                                <ItemTemplate>
                                                    <%#Eval("ASubHeadName")%>
                                                    <asp:Label ID="lblSubHeadIdno" runat="server" Text='<%#Eval("ASubHeadIdno") %>' Visible="false"> </asp:Label>
                                                </ItemTemplate>
                                 </asp:TemplateField>
                                <asp:TemplateField HeaderText="Active" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="30">
                                                ...
                                                <ItemTemplate>
                                                    <asp:ImageButton ID="imgBtnStatus" runat="server" Width="15px" Height="15px" CommandArgument='<%#Eval("ASubHeadIdno")+"_"+Eval("Status") %>'
                                ...
                                <asp:TemplateField HeaderText="Action" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemStyle HorizontalAlign="Center" Width="50" />
                                                <ItemTemplate>
                                                <asp:LinkButton ID="lnkbtnEdit" CssClass="edit" runat="server" CommandArgument='<%#Eval("ASubHeadIdno") %>' CommandName="cmdedit" TabIndex="5" ToolTip="Click to edit"><i class="fa fa-edit icon"></i></asp:LinkButton>
                                        </ItemTemplate> 
                                 </asp:TemplateField> 
                            </Columns>
