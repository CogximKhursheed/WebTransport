...
{
    public partial class PrintInvoiceGeneral : System.Web.UI.Page
    {
        ...
        public void BindDetails(Int64 InvIDno)
        {
            ...
            if (InvDetails != null && InvDetails.Tables.Count > 0 && InvDetails.Tables[0].Rows.Count>0)
            {
                ...
                try
                {
                    lblGeneratedByName.Text = Convert.ToString((InvDetails.Tables[0].Rows[0]["GeneratedBy"] == "" || InvDetails.Tables[0].Rows[0]["GeneratedBy"] == null) ? "" : "Generated by: " + InvDetails.Tables[0].Rows[0]["GeneratedBy"]);
                    lblLastUpdatedByName.Text = Convert.ToString((InvDetails.Tables[0].Rows[0]["ModifiedBy"] == "" || InvDetails.Tables[0].Rows[0]["ModifiedBy"] == null) ? "" : "Last Updated by: " + InvDetails.Tables[0].Rows[0]["ModifiedBy"]);
                }
                catch (Exception ex)
                {
