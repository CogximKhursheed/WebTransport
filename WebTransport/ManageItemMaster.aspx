<%@ Page Title="Item master List" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ManageItemMaster.aspx.cs"
    Inherits="WebTransport.ManageItemMaster" %>
    ...
    <div class="center-block" style="width: 50%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Add Item </h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="ItemMaster.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-12 no-pad">
                        ...
                        <div class="col-sm-6 no-pad">
                            ...
                            <div class="control-holder full-width">
                                 <asp:DropDownList ID="ddlGroupType" runat="server" CssClass="form-control backlight"></asp:DropDownList>     
                            </div>
                        </div>
                        <div class="col-sm-6 no-pad">
                            <div class="control-label"> 
                            ...
                            <div class="control-holder full-width">
                                <asp:TextBox ID="txtItemName" placeholder="Item Name" runat="server" CssClass="form-control backlight" MaxLength="15" ></asp:TextBox>                       
                            </div>
                        </div>
                        <!--SECOND-FOLD-->
                        <div class="col-sm-12 no-pad">
                        ...
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None"  AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" OnRowDataBound="grdMain_RowDataBound">
                            <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="Action" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemStyle HorizontalAlign="Center" Width="50" />
                                                <ItemTemplate>
                                                <asp:LinkButton ID="lnkbtnEdit" CssClass="edit" runat="server" CommandArgument='<%#Eval("ItemIdno") %>' CommandName="cmdEdit" TabIndex="5" ToolTip="Click to edit"><i class="fa fa-edit icon"></i></asp:LinkButton>

                                                 <asp:LinkButton ID="lnkbtnDelete" CssClass="delete" runat="server" CommandArgument='<%#Eval("ItemIdno") %>' OnClientClick="return confirm('Do you want to delete this record ?');" CommandName="cmddelete" TabIndex="6" ToolTip="Click to delete"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                </ItemTemplate>
                                  </asp:TemplateField>
                            </Columns>
