    ...
    <div id="sidebar-scroll">
        <div class="sidebar-content">
            <a href="~/DashBoard.aspx" id="hrfDshBrdssdf" runat="server" class="sidebar-brand logo">
                <h1 style="font-size: 20px;font-weight: bold;text-transform: uppercase;margin: 0;padding: 5px 0 0 0px;">Transport</h1>
                <h2 style="margin: 0;font-size: 18px;">Genius</h2>
            </a>
            <ul class="sidebar-nav">
                ...
                <li><a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide">
                    ...
                    <ul>
                        ...
                        <li><a href="~/AnnexureReport.aspx" id="hrAnnexureReport" runat="server">Annexures</a></li>
                        <li><a href="~/AnnexureSummaryReport.aspx" id="hrAnnexureSummaryReport" runat="server">Annexures Summary Report</a></li>
                    </ul>
                </li>
                <li><a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide">
                    ...
                    <ul>
                        ...
                        <li><a href="#" class="sidebar-nav-submenu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide">
                            ...
                            <ul>
                                ...
                                <li><a href="~/RptCustomTripSheet.aspx" id="A7" runat="server">Custom Trip Sheet</a> </li>
                            </ul>
                        </li>
                    </ul>
                </li>
