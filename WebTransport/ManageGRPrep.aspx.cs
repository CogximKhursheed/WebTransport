...
{
    public partial class ManageGRPrep : Pagebase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                var lstGridData = obj.SelectGR(GrNo, dtfrom, dtto, cityfrom, citydel, citto, senderr, yearidno, UserIdno, strPrefixNum);
                obj = null;
        ...
        private void BindGrid()
        {
            ...
            var lstGridData = obj.SelectGR(GrNo, dtfrom, dtto, cityfrom, citydel, citto, sender, yearidno, UserIdno, strPrefixNum);
            obj = null;
            if (lstGridData != null && lstGridData.Count > 0)
            {
                ...
                for (int i = 0; i < lstGridData.Count; i++)
                {
                    ...
                    dr["GrNo"] = Convert.ToString(DataBinder.Eval(lstGridData[i], "PrefixGr_No")) + Convert.ToString(DataBinder.Eval(lstGridData[i], "Gr_No"));
                    dr["GrDate"] = Convert.ToDateTime(DataBinder.Eval(lstGridData[i], "GR_Date")).ToString("dd-MM-yyyy");
        ...
        protected void grdMain_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("GrPrep.aspx?Gr=" + e.CommandArgument, true);
            }
        ...
        protected void grdMain_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                Int64 ChlnNo = 0; ChlnNo = obj.CheckChallanDetailsForPayment(intGRIdno);
                obj = null;
            ...
            if (e.Row.RowType == DataControlRowType.Footer)
            {
                ...
                lblGrossAmnt.Text = dGrossAmnt.ToString("N2");
