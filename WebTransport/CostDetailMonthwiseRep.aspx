<%@ Page Title="COST CATEOGRY DETAILS" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="CostDetailMonthwiseRep.aspx.cs" Inherits="WebTransport.CostDetailMonthwiseRep" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row ">
            ...
            <div class="col-lg-9">
                <section class="panel panel-default full_form_container part_purchase_bill_form">
                	<header class="panel-heading font-bold">COST CATEOGRY DETAILS&nbsp;
                	<span class="view_print">&nbsp;
                     <b><asp:Label ID="lblTruckNo" runat="server"></asp:Label></b>
    ...
    <script type="text/javascript" language="javascript">
        function CallPrint(strid) {
            ...
            var Unm = $('#<%= lblTruckNo.ClientID %>').text();
