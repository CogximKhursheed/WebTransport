<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RateMasterRetailerParty.aspx.cs" Inherits="WebTransport.RateMasterRetailerParty" %>
            ...
            <div class="row ">
                ...
                <div class="col-lg-8">
                    <section class="panel panel-default full_form_container part_purchase_bill_form">
	                  <header class="panel-heading font-bold form_heading"> Rate Master Retailer [Party Wise]
	                        ...
	                        <section class="panel panel-in-default">  
	                          <div class="panel-body">
                                  ...
                                  <div class="col-sm-4">
                                   ...
                                   <div class="col-sm-4">
	                                <label class="control-label">Transportation Type<span class="required-field">*</span></label>
	                                <div>
                                     <asp:DropDownList ID="ddlTranType" runat="server" CssClass="form-control"  
                                            TabIndex="5" onselectedindexchanged="ddlTranType_SelectedIndexChanged" AutoPostBack="true" >                                                                       
                                     </asp:DropDownList>                                                                                                                                 
	                                </div>
	                              </div>
	                            </div>	                                                
	                        ...
	                        <section class="panel panel-in-default btns_without_border">                            
                              ...
                              <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" 
                                    ...
                                    ShowFooter="true"  PageSize="30 " 
                                      onpageindexchanging="grdMain_PageIndexChanging1" 
                                      onrowcommand="grdMain_RowCommand1" 
                                      onrowdatabound="grdMain_RowDataBound1"  >
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="City From" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="Left">
                                          ...
                                          <asp:TemplateField HeaderText="Tran. Type" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="Left">
                                            <HeaderStyle HorizontalAlign="Left" Width="50px" />
                                            <ItemStyle Width="50" HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <%#Convert.ToString(Eval("Tran_Type"))%>
                                                <asp:Label ID="lblTranIdno" Visible="false"  runat="server" Text='<%#Eval("TranType_Idno")%>'></asp:Label>
                                            </ItemTemplate>                                         
                                        </asp:TemplateField>
