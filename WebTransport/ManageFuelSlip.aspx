<%@ Page Title="Manage Fuel Slip" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ManageFuelSlip.aspx.cs"
    Inherits="WebTransport.ManageFuelSlip" %>
    ...
    <div class="center-block" style="width: 100%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Fuel Slip List </h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="FuelSlip.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
            <div class="ibox-content">
                <div class="">
                            ...
                            <div class="control-holder full-width">
                                <asp:TextBox ID="txtSlipNo" PlaceHolder="Slip Number" runat="server"  CssClass="form-control backlight" ></asp:TextBox>
                            </div>
                        </div>
                                <div class="col-sm-4 no-pad">
                            <div class="control-label"> 
                            ...
                            <div class="control-holder full-width">
                                  <asp:DropDownList ID="ddlLorry" runat="server" CssClass="form-control backlight" > </asp:DropDownList>    
                            </div>
                        </div>
                                <div class="col-sm-4 no-pad">
                            <div class="control-label"> 
                            ...
                            <div class="control-holder full-width">
                                <asp:DropDownList ID="ddlPPump" runat="server" CssClass="form-control backlight"> </asp:DropDownList>  
                            </div>
                        </div>
                                <!--SECOND-FOLD-->
                                <div class="col-sm-12 no-pad">
                        ...
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" OnRowDataBound="grdMain_RowDataBound">
                            <Columns>
                                <asp:TemplateField HeaderText="Action" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="Center">
                                                    ...
                                                    <ItemTemplate>
                                                            <asp:LinkButton ID="lnkbtnEdit" CssClass="edit" runat="server" CommandArgument='<%#Eval("ID") %>' CommandName="cmdEdit" TabIndex="7" ToolTip="Click to edit"><i class="fa fa-edit icon"></i></asp:LinkButton>
                                                            <asp:LinkButton ID="lnkbtnDelete" CssClass="delete" runat="server" CommandArgument='<%#Eval("ID") %>' OnClientClick="return confirm('Do you want to delete this record ?');" CommandName="cmddelete" TabIndex="8" ToolTip="Click to delete"><i class="fa fa-trash-o"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Slip No." HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150px">
                                ...
                                <asp:TemplateField HeaderText="Location" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150px">
                                                    <HeaderStyle HorizontalAlign="Left" Width="150px" />
                                ...
                                <asp:TemplateField HeaderText="Lorry Name" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="120">
                                                    <HeaderStyle HorizontalAlign="Left" Width="120px" />
                                                    <ItemStyle HorizontalAlign="Left" Width="120" />
                                                    <ItemTemplate>
                                                        <%#Eval("LorryName")%>
                                ...
                                <asp:TemplateField HeaderText="Driver" HeaderStyle-HorizontalAlign="Center"
                                ...
                                <asp:TemplateField HeaderText="Petrol Pump" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="120">
                                                    <HeaderStyle HorizontalAlign="Left" Width="120px" />
                                                    <ItemStyle HorizontalAlign="Left" Width="120" />
                                                    <ItemTemplate>
                                                        <%#Eval("Pump")%>
                                ...
                                <asp:TemplateField HeaderText="Item Name" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="110">
                                ...
                                <asp:TemplateField HeaderText="Qty" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100">
                                                    ...
                                                    <ItemTemplate>
                                                                <%# Convert.ToString(Eval("Qty")) == "" ? Convert.ToDouble(0).ToString("N2") : Convert.ToDouble(Eval("Qty")).ToString("N2")%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Amount" HeaderStyle-HorizontalAlign="Center" HeaderStyle-Width="100">
                                                    <HeaderStyle HorizontalAlign="Center" Width="100px" />
                                                    <ItemStyle HorizontalAlign="right" Width="100" />
                                                    <ItemTemplate>
                                                                <%# Convert.ToString(Eval("Amount")) == "" ? Convert.ToDouble(0).ToString("N2") : Convert.ToDouble(Eval("Amount")).ToString("N2")%>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                            </Columns>
