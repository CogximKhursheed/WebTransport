...
{
    public partial class CostLedgerRep : Pagebase
    {
        #region Variable...
        string conString = "", msg = "";
        Double dNetAmount1 = 0, dNetAmount2 = 0, bal = 0, bal1 = 0;
        private int intFormId = 55;
        CostLedgerDAL objAccountBookDAL = new CostLedgerDAL();
        #endregion
        ...
        protected void grdMain_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "cmdshowdetail")
            {
                ...
                Session["PrtyName"] = Convert.ToString(ddlParty.SelectedItem.Text);
                Session["PrtyIdno"] = Convert.ToInt64(ddlParty.SelectedValue);
                Session["TruckIdno"] = TruckIdno;
                ...
                Response.Redirect("CostLedgerDetailMonthwiseRep.aspx?YearIdno=" + YearIdno + "&StartDate=" + startDate + "&Enddate=" + EndDate);
                #endregion
            }
