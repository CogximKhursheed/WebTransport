<%@ Page Title="Manage Opening Stock [Tyre]" Language="C#" MasterPageFile="~/Site1.Master"
    EnableEventValidation="false" AutoEventWireup="true" CodeBehind="ManageOpenStock.aspx.cs"
    Inherits="WebTransport.ManageOpenStock" %>
    ...
    <div class="center-block" style="width: 50%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Opening Stock [Tyre] LIST </h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="OpenStock.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
                ...
                <div class="panel-in-default" >
                    ...
                    <div class="report" style="overflow-x:Auto; width:100%;">
                        ...
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None" AllowPaging="true" PageSize="50"  OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" OnRowDataBound="grdMain_RowDataBound" >
                            <Columns>
                                 <asp:TemplateField HeaderStyle-CssClass="gridHeaderAlignCenter" HeaderStyle-Width="50" HeaderText="Sr.No">
                                 ...
                                 <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="100" HeaderText="Location">                                      
                                        <ItemTemplate>
                                            <%#Eval("LocName")%>
                                             <asp:HiddenField  ID="hidLocId" runat="server" Value='<%#Eval("LocIdno") %>'/>
                                            <asp:HiddenField  ID="hidYearId" runat="server" Value='<%#Eval("YearId") %>'/>
                                        </ItemTemplate>
                                    </asp:TemplateField>   
                                 <asp:TemplateField HeaderStyle-CssClass="gridHeaderAlignCenter" HeaderStyle-Width="80" HeaderText="Qty">
                                 ...
                                 <asp:TemplateField HeaderText="Get Excel" HeaderStyle-Width="100" HeaderStyle-CssClass="gridHeaderAlignCenter">      
                    ...
                    <div class="secondFooterClass"  id="divpaging" runat="server" visible="false">                                                                           
                        <table class="" id="tblFooterscnd" runat="server" >
		                    <tr><th rowspan="1" colspan="1" style="width:300px;">
                             <asp:Label ID="lblcontant" runat="server"></asp:Label></th>
                             <th rowspan="1" colspan="1" style="width: 149px;"></th><th rowspan="1" colspan="1" style="width: 300px;text-align:right;"></th>
                             <th rowspan="1" colspan="1" style="width: 210px; text-align: right;"><asp:Label ID="lblNetTotalAmount" runat="server"></asp:Label>
