...
{
    public partial class CostLedgerVchrDetail : Pagebase
    {
        #region Variabless...
        string conString = "";
        ...
        private DataTable ConvertToDataTable()
        {
            ...
            Int64 PrtyIdno = Convert.ToInt64(Session["PrtyIdno"]);
            ...
            ds1 = objAccountBookDAL.AfterDoubleClick1(ApplicationFunction.ConnectionString(), "SelectIdDetailReport", intpartyidno,PrtyIdno, strDateFrom, strDateTo);
