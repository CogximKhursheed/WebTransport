<%@ Page Title="Manage Item Group Master" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ManageItmGrpMaster.aspx.cs"
    Inherits="WebTransport.ManageItmGrpMaster" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Item Group Master List </h5>
                <div class="pull-right title-action">
                    ...
                    <div class="ibox-content">
                        <div class="">
                           ...
                           <asp:TextBox ID="txtGName" runat="server" placeholder="Enter Group Name" CssClass="form-control backlight" MaxLength="50" TabIndex="1" onDrop="blur();return false;" onpaste="return false" oncut="return false" oncopy="return false"></asp:TextBox>                                 
                            </div>
                        </div>
                                <!--SECOND-FOLD-->
                                <div class="col-sm-6 no-pad">
                    ...
                    <div class="report" style="overflow-x:Auto; width:100%;">
                        ...
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" OnRowDataBound="grdMain_RowDataBound">
                            ...
                            <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Group Name" HeaderStyle-HorizontalAlign="Left" HeaderStyle-Width="150">
                            ...
                            <ItemTemplate>
                                <asp:ImageButton ID="imgBtnStatus" runat="server" Width="15px" Height="15px" CommandArgument='<%#Eval("IGrp_Idno")+"_"+Eval("Status") %>'
                            ...
                            <ItemStyle HorizontalAlign="Center" Width="50" />
                            <ItemTemplate>
                                <asp:ImageButton ID="lnkbtnEdit" runat="server" ImageUrl="~/Images/edit_sm.png" CommandArgument='<%#Eval("IGrp_Idno") %>'
                                    CommandName="cmdedit" ToolTip="Click to edit" />


                                <asp:ImageButton ID="lnkbtnDelete" runat="server" ImageUrl="~/Images/delete_sm.png"
                                    OnClientClick="return confirm('Do you want to delete this record ?');" CommandArgument='<%#Eval("IGrp_Idno") %>'
                                    CommandName="cmddelete" ToolTip="Click to delete" />
                            </ItemTemplate>
                        </asp:TemplateField>
                            </Columns>
