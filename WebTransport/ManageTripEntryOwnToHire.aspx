<%@ Page Title="Manage Trip Entry" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" CodeBehind="ManageTripEntryOwnToHire.aspx.cs" EnableEventValidation="false"
    Inherits="WebTransport.ManageTripEntryOwnToHire" %>
    ...
    <div class="center-block" style="width: 80%; margin-top: 30px; display: block;">
        <section class="panel panel-default full_form_container part_purchase_bill_form auto-height-form" style="box-shadow: 0 0px 2px gray; border: none; margin-top: 30px">
            ...
            <div class="ibox-title">
                <h5><div class="printing-animation icon-size"></div>Manage Trip Entry [Own To Hire] </h5>
                <div class="pull-right title-action">
                    <div class="action-center">
                        ...
                        <a href="TripSheetOwnToHire.aspx"><i style="font-size: 13px !important;" class="fa fa-plus action-icon-style1"></i></a>
                    </div>
                </div>
            </div>
                        ...
                        <asp:GridView ID="grdMain" runat="server" CssClass="table-style-white last-row-select" AutoGenerateColumns="false" BorderStyle="None" Width="100%" GridLines="None" AllowPaging="true" PageSize="35" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand"    OnRowDataBound="grdMain_RowDataBound">
                            <Columns>
                                 ...
                                 <asp:TemplateField HeaderText="Date" HeaderStyle-CssClass="gridHeaderAlignCenter" HeaderStyle-Width="100">
                                                        ...
                                                        <ItemTemplate>
                                                            <%#Convert.ToDateTime(Eval("TripOTH_Date")).ToString("dd-MM-yyyy")%>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                 ...
                                 <asp:TemplateField HeaderText="Action" HeaderStyle-Width="50" HeaderStyle-CssClass="gridHeaderAlignCenter">
                                                        ...
                                                        <ItemStyle HorizontalAlign="Center" Width="50" />
                                                        <ItemTemplate>
                                                        <asp:LinkButton runat="server" CssClass="edit" ID="lnkBtnEdit"  CommandArgument='<%#Eval("TripOTH_Idno") %>' CommandName="cmdedit" ToolTip="Edit"><i class="fa fa-edit icon"></i></asp:LinkButton>
                                                            <asp:LinkButton runat="server" CssClass="edit" ID="lnkBtnDelete"   OnClientClick="return confirm('Do you want to delete this record ?');" CommandArgument='<%#Eval("TripOTH_Idno") %>' CommandName="cmddelete" ToolTip="Delete"><i class="fa fa-trash-o"></i></asp:LinkButton>
