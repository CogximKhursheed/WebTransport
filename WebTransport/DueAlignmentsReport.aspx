<%@ Page Title="Due Alignment Report" Language="C#" MasterPageFile="~/Site1.Master"
    AutoEventWireup="true" CodeBehind="DueAlignmentsReport.aspx.cs" EnableEventValidation="false"
    Inherits="WebTransport.DueAlignmentsReport" %>
                    ...
                    <div class="ibox float-e-margins maximizing-form">
                        ...
                        <div class="col-sm-12 fliter-section">
                            ...
                            <div class="filter" style="width: 400px; display: none;">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-12 pull-left">
                                            <div class="control-holder full-width">
                                                <span class="filter-label">Fin. Year</span>
                                            </div>
                                            <div class="control-holder full-width">
                                        ...
                                        <div class="col-sm-6 pull-left">
                                            ...
                                            <div class="control-holder full-width">
                                                <asp:DropDownList ID="drpLorryNo" runat="server" CssClass="form-control"></asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12 pull-right">
                                    <asp:ImageButton ID="imgBtnSelect" runat="server" Width="35px" Height="25px" ImageUrl="~/Images/active.png" CommandName="SelectAll" ToolTip="Select All" OnClick="imgBtnSelect_Click" />
                                    &nbsp;
                                    <asp:ImageButton ID="imgBtnDeselect" runat="server" Width="35px" Height="25px" ImageUrl="~/Images/inactive.png" CommandName="DeselectAll" ToolTip="Deselect All" OnClick="imgBtnDeselect_Click" />
                                </div>
                                <div class="col-sm-12 pull-right">
                                    <asp:LinkButton ID="lnkSendSMS" CssClass="btn full_width_btn btn-sm btn-primary" runat="server" OnClick="lnkSendSMS_Click"></i>Send SMS</asp:LinkButton>
                                </div>
                            </div>
                                            ...
                                            <td>
                                                <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" BorderStyle="None" CssClass="u-table u-table-green u-table-stripped fixed-header-table bold-last-row row-selection no-wrap-cell" GridLines="None" BorderWidth="0" ShowFooter="true" AllowPaging="true" PageSize="50" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCommand="grdMain_RowCommand" OnRowDataBound="grdMain_RowDataBound">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Phone No." HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="Right">
                                                            <ItemStyle HorizontalAlign="Right" Width="70" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblPhone" runat="server" Text='<%#Eval("PhoneNo")%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Save For SMS" HeaderStyle-Width="70" HeaderStyle-HorizontalAlign="Center">
                                                            <ItemStyle HorizontalAlign="Center" Width="70" />
                                                            <ItemTemplate>
                                                                <asp:CheckBox ID="chkSave4SMS" runat="server"></asp:CheckBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                    </Columns>
