<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Ultratech.aspx.cs" Inherits="WebTransport.Ultratech" %>
     ...
     <table cellpadding="1" cellspacing="0" width="1100px" border="0" style="font-family: Arial,Helvetica,sans-serif;
            ...
            <td colspan="3">
             <div      style="text-align:left;Width:140px; float:left;">
                ...
                <div id="header" runat="server"  align="center" class="white_bg"  style="font-size: 14px;
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <tr style="font-size: 12px;  ">
                                    ...
                                    <td  style="font-size: 12px;  " class="white_bg" width="5%" align="left">
                                        <%#Eval("Consignee")%>
                                    </td>
                                    ...
                                    <td style="font-size: 12px;  " class="white_bg" width="6%" align="right">
                                        <%#Convert.ToDouble(Eval("Shortage_Qty")).ToString("N2")%>
                                    </td>
                                </tr>
                            </ItemTemplate>
                            <FooterTemplate>
                            ...
                            <td style="font-size: 12px;  " width="6%" align="right">
                                <strong><asp:Label ID="lblTotalShBags" runat="server"></asp:Label></strong>
                            </td>
                             </tr>
                            </FooterTemplate>
                        </asp:Repeater>
