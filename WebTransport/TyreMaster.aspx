<%@ Page Title="Tyre Type Master" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true"
    CodeBehind="TyreMaster.aspx.cs" Inherits="WebTransport.TyreMaster" %>
                ...
                <div class="col-lg-5 center-block">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5><i class="animated-icon fas fa-gas-pump"></i>Tyre Type Master </h5>
                            <div class="title-action">
                                <asp:Label ID="lblViewList" runat="server"><a class="btn-action white-o" href="ManagetyreMaster.aspx"><i class="fa fa-list"></i>List</a></asp:Label>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-12 no-pad">
                                <div class="form-control-row">
                                    <div class="control-container col-sm-12">
                                        ...
                                        <asp:TextBox ID="txtItemName" placeholder="Enter tyre type Name " runat="server" CssClass="form-control" MaxLength="50" onDrop="blur();return false;" onpaste="return false" oncut="return false" oncopy="return false"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="rfvItemNamee" runat="server" ControlToValidate="txtItemName" CssClass="classValidation" Display="Dynamic" ErrorMessage="Please enter tyre type Name!" SetFocusOnError="true" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                                <div class="form-control-row">
                                    <div class="control-container col-sm-12">
