<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintInvWonderCement.aspx.cs" Inherits="WebTransport.PrintInvWonderCement" %>
...
<body>
    ...
    <table cellpadding="1" cellspacing="0" width="1100px" border="0" style="font-family: Arial,Helvetica,sans-serif;height:70%">
                        <tr>
                            ...
                            <asp:Image ID="imgWondercement1" Width="140px" Height="80px" runat="server" Visible="false"></asp:Image>
                                ...
                                <%--<td align="center" class="white_bg" valign="top" colspan="4" style="font-size: 14px;
                                   ...
                                   <div id="header" visible="false" runat="server" align="center" class="white_bg" style="font-size: 14px;
                                    border-left-style: none; border-right-style: none">
                                            <strong>
                            ...
                            <tr>
                                <td align="center" class="white_bg" valign="top" colspan="4" style="font-size: 14px;text-decoration: underline;
                                    ...
                                    <b>TRANSPORTATION FREIGHT BILL (Basic) : WCL-CEMENT</b>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="4">
                                    <table border="0" width="100%" style="border-top:1px solid #484848;border-bottom:1px solid #484848;">
                                        <tr>
                                            <td colspan="3" align="left" class="white_bg" style="width:18%;font-size: 13px; border-right-style: none" valign="top" >
                            ...
                            <tr>
                                <td colspan="4">
                                    <table cellspacing="0" style="font-size: 13px;" width="100%" id="Table1">
                                        <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                                            <HeaderTemplate>
                                                <tr>
                                                    ...
                                                    <td style="font-size: 13px" align="left" width="10%">
                            ...
                            <tr>
                                <td colspan="4" style="border-bottom:1px solid #484848;">
                                           ...
                                           <td>
                                            <table width="250px" style="font-size: 13px;">
                                             <tr>
                                ...
                                <td colspan="4" style="border-bottom:1px solid #484848;">
                                       <table style="font-size: 13px;">
                                           ...
                                           <td>
                                            <table border="0" width="250px" style="font-size: 13px;">
                                ...
                                <tr>
                                <td style="font-size: 13px;border-bottom:1px solid #484848;" colspan="4" 
                                        class="style1">
                                      <table width="100%" style="font-size: 13px;">
                                           <tr>
                                           <td>
                                ...
                                <td style="font-size: 13px;" colspan="4">
                                     <table style="font-size: 13px;">
                                           ...
                                           <td>
                                            <table border="0" width="250px" style="font-size: 13px;border-left:1px solid #484848;">
                                             <tr>
    ...
    <table cellpadding="1" cellspacing="0" width="1100px" border="0" style="font-family: Arial,Helvetica,sans-serif;
             ...
             <div style="text-align:left;Width:140px; float:left;">
               <asp:Image ID="imgWondercement2" Width="140px" Height="80px" runat="server" Visible="false"></asp:Image>
                ...
                <div id="Header1" runat="server" visible="false" align="center" class="white_bg" style="font-size: 14px;
                    ...
                    <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Label ID="lbldel" runat="server" Font-Bold="true" Text="TRANSPORTATION FREIGHT BILL (Unloading) : CEMENT FWD BNG" Font-Underline="True"></asp:Label><br />
                <br />
                <br />
                </div>
                 </td>
            ...
            <tr>
                <td colspan="4">
                    <table border="1" cellspacing="0" style="font-size: 13px" width="100%" id="Table3">
                        <asp:Repeater ID="Repeater2" runat="server" OnItemDataBound="Repeater2_ItemDataBound">
                            <HeaderTemplate>
                                <tr>
                                    <td class="white_bg" style="font-size: 13px" width="3%">
                                        <strong>S.No.</strong>
                                    </td>
                                    ...
                                    <td style="font-size: 13px" align="left" width="6%">
                                        <strong>Truck No</strong>
                                    </td>
                                    <td style="font-size: 13px" align="left" width="8%">
                                        <strong>Destination</strong>
                                    </td>
                                    <td style="font-size: 13px" width="8%" align="left">
                                        <strong>DSP QTY</strong>
                                    </td>
                                    <td style="font-size: 13px" width="8%">
                                        <strong>Rate</strong>
                                    </td>
                                    <td style="font-size: 13px" width="7%">
                ...
                <td colspan="4" align="right">
                    <table border="1" cellspacing="0" style="font-size: 13px" width="100%" id="Table4">
                        <tr>
                            ...
                            <td style="font-size: 13px" width="5%" align="center">
                            </td>
                            <td style="font-size: 13px" width="8%">
                            </td>
                            <td style="font-size: 13px" width="8%">
                            ...
                            <td style="font-size: 13px" align="center" width="6%">
                                <strong>TOTAL</strong>
                            </td>
                            <td style="font-size: 13px" align="center" width="7%">
                             
                            </td>
                            <td style="font-size: 13px" width="8%" align="center">
                                <asp:Label ID="lblWeight" Font-Bold="true" runat="server"></asp:Label>
                            </td>
                            <td style="font-size: 13px" width="7%">
                            </td>
                            <td style="font-size: 13px" width="7%" align="center">
                        ...
                        <tr>
                            <td colspan="5" align="left" width="43%" style="font-size:13px">
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td width="80%" align="left" colspan="2" style="font-size:13px">
