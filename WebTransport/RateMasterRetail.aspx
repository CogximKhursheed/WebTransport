<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="RateMasterRetail.aspx.cs" Inherits="WebTransport.RateMasterRetail" %>
	                      ...
	                      <div class="clearfix first_section">
	                        <section class="panel panel-in-default">  
	                          <div class="panel-body">
                                ...
                                <div>
                                    <asp:DropDownList ID="ddlTranType" CssClass="form-control" runat="server" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="IR.Type" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="Left">
                                           ...
                                           <asp:TemplateField HeaderText="Tran. Type" HeaderStyle-Width="50" HeaderStyle-HorizontalAlign="Left">
                                            ...
                                            <ItemStyle Width="50" HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <asp:Label ID="lblTranType" runat="server" Text='<%#(string.IsNullOrEmpty(Convert.ToString(Eval("Tran_Type"))) ? "" : (Convert.ToString((Eval("Tran_Type")))))%>'></asp:Label>
                                                <asp:HiddenField ID="HiTranType" runat="server" Value=' <%#Convert.ToString(Eval("TranType_Idno"))%>' />
                                            </ItemTemplate>
                                        </asp:TemplateField>
