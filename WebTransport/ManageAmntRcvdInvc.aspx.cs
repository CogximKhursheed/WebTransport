...
{
    public partial class ManageAmntRcvdInvc : Pagebase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                {
                    hidDeleteRight.Value = "False";
                }
                else
                {
                    hidDeleteRight.Value = "True";
                }
                this.BindDateRange();
                ddldateRange.SelectedIndex = 0;
                ddldateRange_SelectedIndexChanged(null, null);
                //Commented -- Populating data on load takes time 
                //RcvdAmntAgnstInvcDAL obj = new RcvdAmntAgnstInvcDAL();
                //var lstGridData = obj.search(Convert.ToInt32(ddldateRange.SelectedValue), txtRcptNo.Text, Convert.ToDateTime(ApplicationFunction.mmddyyyy(txtInvcDatefrom.Text)), Convert.ToDateTime(ApplicationFunction.mmddyyyy(txtInvcDateto.Text)), Convert.ToInt32(ddlFromCity.SelectedValue == null ? "0" : ddlFromCity.SelectedValue));
        ...
        protected void grdMain_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("AmntAgainstInvoice.aspx?q=" + e.CommandArgument, true);
            }
