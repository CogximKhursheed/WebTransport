...
{
     public partial class PJLTaxInvoice : System.Web.UI.Page
    {
        ...
        private void PrintInvoice(String HeadIdno)
        {
            ...
            DataSet dsReport = SqlHelper.ExecuteDataset(ApplicationFunction.ConnectionString(), CommandType.Text, "EXEC [spInvGen] @ACTION='printtaxinvoice',@Id='" + HeadIdno + "'");
            ...
            lblstate.Text = State;
            lblmobile.Text = PhNo;
            lblgstin.Text = lbgst.Text=  GSTIN;
            ...
            double total = Convert.ToDouble(lbltaxvalue.Text);
        ...
        protected void Repeater1_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                lbltaxvalue.Text = dtotAmnt.ToString("N2"); 
            }
        }
