...
{
    public partial class RateMasterWithParty : Pagebase
    {
        ...
        {
            if (ddlItemName.SelectedIndex > 0 && drpBaseCity.SelectedIndex > 0 && ddlPartyName.SelectedIndex > 0)
            {
                BindGrid();
                //txtDateRate.Focus();
            }
        ...
        protected void lnkbtnNew_OnClick(object sender, EventArgs e)
        {
            ...
            Response.Redirect("~/RateMasterWithParty.aspx");
        }
        #endregion
    }
}