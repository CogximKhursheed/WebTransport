<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintInvWonderCementGST.aspx.cs" Inherits="WebTransport.PrintInvWonderCementGST" %>
    ...
    <div id="printShreeCementLtdBeawer" visible="false" runat="server">
                        ...
                        <tr>
                            <td style="width:75%">
                                <table style="font-size: 11px;" class="gap-less">
                                    ...
                                    <tr>
                                        <td><asp:Label ID="lblSupplyStateName" runat="server" ></asp:Label></td>
                                        <td><asp:Label ID="lblSupplyStateId" runat="server" ></asp:Label></td>
                                    </tr>
                                </table>
                            </td>
                            <td>
                ...
                <td colspan="2">
                    <table border="1" cellspacing="0" cellpadding="0" style="font-size: 11px;" width="100%" id="Table1">
                        <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td class="white_bg" style="font-size: 11px;text-align:right">
                                  ...
                                  <%--  <td style="font-size: 11px;" align="right">
                                    ...
                                    <td style="font-size: 11px;display:none" align="center">
                                        <%#Convert.ToString(Eval("CGST_Per", "{0:F0}"))%>%<br /><%#Eval("CGST_Amt")%>
                                    </td>
                                    <td style="font-size: 11px;display:none" align="center">
            ...
            <td>
               <table border="1" cellspacing="0" cellpadding="0" style="font-size: 11px;" width="300px" id="Table2">
                ...
                <span style="font-size:11px;">Freight as applicable will be paid by service recepient under RCM</span>
                <br />
