<%@ Page Title="Accessory Stock Report" Language="C#" MasterPageFile="~/Site1.Master"
    EnableEventValidation="false" CodeBehind="AccessoryStockReport.aspx.cs" Inherits="WebTransport.AccessoryStockReport" %>
                                            ...
                                            <td>
                                                <asp:GridView ID="grdMain" runat="server" AutoGenerateColumns="false" BorderStyle="None" CssClass="u-table u-table-green u-table-stripped fixed-header-table bold-last-row row-selection no-wrap-cell" GridLines="None" BorderWidth="0" ShowFooter="true" AllowPaging="true" PageSize="50" OnRowDataBound="grdMain_RowDataBound" OnPageIndexChanging="grdMain_PageIndexChanging" OnRowCreated="grdMain_RowCreated">
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Name" HeaderStyle-Width="100" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemStyle HorizontalAlign="Left" Width="100" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblModelName" ToolTip='<%#Eval("PartNo")%>' runat="server"><%#Convert.ToString(Eval("PartNo")).Length > 23 ? Convert.ToString(Eval("PartNo")).Substring(0, 23) + "..." : Eval("PartNo")%></asp:Label>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <b>Grand Total</b>
                                                            </FooterTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Description" HeaderStyle-Width="100" HeaderStyle-HorizontalAlign="Left">
                                                            <ItemStyle HorizontalAlign="Left" Width="100" />
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblModelName" ToolTip='<%#Eval("Description")%>' runat="server"><%#Convert.ToString(Eval("Description")).Length > 23 ? Convert.ToString(Eval("Description")).Substring(0, 23) + "..." : Eval("Description")%></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="OP." HeaderStyle-Width="100" HeaderStyle-HorizontalAlign="right">
                                                        ...
                                                        <asp:TemplateField HeaderText="PUR." HeaderStyle-Width="100" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="100" />
                                                            <ItemTemplate>
                                                                <%#Eval("Purchase")%>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="STK.RECV" HeaderStyle-Width="100" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="100" />
                                                            <ItemTemplate>
                                                                <%#Eval("StkRec")%>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Total" HeaderStyle-Width="100" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="100" />
                                                            <ItemTemplate>
                                                                <%#Eval("Total")%>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="SALE" HeaderStyle-Width="100" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="100" />
                                                            <ItemTemplate>
                                                                <%#Eval("Sale")%>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Issued" HeaderStyle-Width="100" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="100" />
                                                            <ItemTemplate>
                                                                <%#Eval("MtrlIss")%>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="SKT.TRANS" HeaderStyle-Width="100" HeaderStyle-HorizontalAlign="right">
                                                            <ItemStyle HorizontalAlign="right" Width="100" />
                                                            <ItemTemplate>
                                                                <%#Eval("StkTrns")%>
                                                            </ItemTemplate>
                                            ...
                                            <td>
                                                ...
                                                <b>
                                                    <div class="secondFooterClass" id="divpaging" runat="server" visible="false">
                                                        <div class="col-sm-2" style="text-align: left; width: 26%">
                                                            <asp:Label ID="lblcontant" runat="server"></asp:Label>
                                                        </div>
                                                        <div class="col-sm-1">TOTAL &nbsp;&nbsp;&nbsp;</div>
                                                        <div class="col-sm-1" style="width: 70px; text-align: left">
                                                            <asp:Label ID="lblTotOpening" runat="server"></asp:Label>
                                                        </div>
                                                        <div class="col-sm-1" style="width: 130px; text-align: left">
                                                            <asp:Label ID="lblTotPur" runat="server"></asp:Label>
                                                        </div>
                                                        <div class="col-sm-1" style="width: 83px; text-align: left">
                                                            <asp:Label ID="lblTotRecv" runat="server"></asp:Label>
                                                        </div>
                                                        <div class="col-sm-1" style="width: 115px; text-align: left">
                                                            <asp:Label ID="lblTotal" runat="server"></asp:Label>
                                                        </div>
                                                        <div class="col-sm-1" style="width: 99px; text-align: left">
                                                            <asp:Label ID="lblTotSale" runat="server"></asp:Label>
                                                        </div>
                                                        <div class="col-sm-1" style="width: 98px; text-align: left">
                                                            <asp:Label ID="lblTotIssue" runat="server"></asp:Label>
                                                        </div>
                                                        <div class="col-sm-1" style="width: 85px; text-align: left">
